...
function Testimonials() {
  return (
    <>
      <section className="tf-section3 bg-testimonial overflow-hidden">
        <div className="container">
          ...
          <div className="tf-testimonial-widget wow fadeInUp">
            <Swiper
              ...
              slidesPerGroup={1}
              navigation={{
                nextEl: ".about-us-testimonials-next",
                prevEl: ".about-us-testimonials-prev",
              }}
              pagination={{
                el: ".about-us-testimonials-pagination",
                clickable: true,
              }}
              breakpoints={{
                575: { slidesPerView: 2, spaceBetween: 12, slidesPerGroup: 1 },
                768: { slidesPerView: 2, spaceBetween: 12, slidesPerGroup: 1 },
            ...
            >
              ...
              <span className="d-flex d-xl-none sw-dot-default about-us-testimonials-pagination justify-content-center" />
            </Swiper>
            <div className="swiper-button-next about-us-testimonials-next" />
            <div className="swiper-button-prev about-us-testimonials-prev" />
          </div>
        </div>
      </section>
    </>
