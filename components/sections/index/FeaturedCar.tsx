...
function FeaturedCar() {
  return (
    <>
      <section className="section-feature-specs">
        <div className="container">
          <div className="row">
            <div className="col-lg-7">
              <div className="image-feature-specs relative">
                <div className="specs-title">
                  <div className="text-specs wow fadeInRight">2026</div>
                  <div
                    className="text-specs wow fadeInLeft"
                    data-wow-delay="0.2s"
                  >
                    SKODA
                  </div>
                ...
                <div
                  className="image-inner wow fadeInLeft"
                  data-wow-delay="0.4s"
                >
                  <Image
                    className="lazyload"
                    data-src="/assets/images/section/specs1.webp"
                    src="/assets/images/section/specs1.webp"
                    alt="images"
                    width={828}
                    height={303}
                  />
            ...
            <div className="col-lg-5">
              <div className="content-feature-specs">
                <div className="heading-section wow fadeInUp">
                  <h2 className="heading-tittle">Featured Car</h2>
                  <p className="fs-18 fw-4 text-color-2">
                    Check out or book a test drive of the latest car with
                    HMP
                  </p>
                </div>
                <div
                  className="feature-specs-box wow fadeInUp"
                  data-wow-delay="0.2s"
                >
                  <div className="content">
                    <div className="top-box flex-two gap-20">
                      <div className="money fs-24 fw-7 text-color-2">
                        $72,500
                      </div>
                      <ListingCardActions
                        car={featuredCar}
                        className="style-2 flex"
                        iconClassName=""
                        variant="featured"
                      />
                    </div>
                    ...
                    <div className="icon-box flex flex-wrap">
                      <div className="icons flex-three">
                        ...
                        <span>{featuredCar.mileage} Km</span>
                      </div>
                      <div className="icons flex-three">
                    ...
                    <div className="days-box flex justify-space align-center">
                      <div className="img-author flex-three">
                        <Image
                          className="lazyload"
                          data-src="/assets/images/author/avt-list1.webp"
                          src="/assets/images/author/avt-list1.webp"
                          alt="image"
                          width={60}
                          height={60}
                        />
                        <div className="content-infor">
                          <span className="fs-14 text-color-2 fw-7">
                            HMP auto
                          </span>
                          <p className="fs-12 fw-4">44 minutes ago</p>
                        </div>
                      </div>
                      <Link
