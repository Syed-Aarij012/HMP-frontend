...
function NewCars() {
  const [activeTab, setActiveTab] = useState(newCarBodyTypeTabs[0]);

  const filteredCars = useMemo(() => {
    return newCars.filter((car) => car.bodyType?.includes(activeTab));
  }, [activeTab]);
      ...
      <section className="tf-section">
        <div className="container">
          <div className="heading-section flex align-center justify-space flex-wrap gap-20 wow fadeInUp">
            <h2 className="heading-tittle">New Cars By Body Type</h2>
