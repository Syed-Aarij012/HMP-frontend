...
import { home05HeroSlides } from "@/data/hero";
...
function Hero() {
  ...
  return (
    <Swiper
      ...
      className="swiper mainslider1 slider style11"
      slidesPerView={1}
      speed={500}
      effect="fade"
    ...
    >
      {home05HeroSlides.map((slide, index) => (
            ...
            <div className="container full relative">
              <div className="content">
                <div className="heading">
                  <div className="fs-18 fw-6 luxury fade-item fade-item-1">
                    {slide.subtitle}
                  </div>
                  <h1 className="text-color-1 fade-item fade-item-2">
                    {slide.title}
                  </h1>
                  <p className="text-color-1 font fade-item fade-item-3">
                    {slide.description}
                  </p>
      ...
      <div className="slider-bottom">
        <div className="slider-vertical-counter">
          ...
          <div className="number bottom">
            {String(home05HeroSlides.length).padStart(2, "0")}
          </div>
        </div>
      </div>
    </Swiper>
