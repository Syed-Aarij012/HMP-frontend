...
// docblock for why this quotes Hire Purchase specifically (the template's forms have no
// product-type picker, and HP is the one product that doesn't need a balloon payment input).
...
export default function AutoLoanCalculatorForm() {
