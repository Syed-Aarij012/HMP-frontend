                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car56.webp"
                        src="/assets/images/car-list/car56.webp"
                        alt="image"
                        width={507}
                        height={365}
                      />
                  ...
                  <div className="content">
                    <div className="content-wrap">
                      <h3 className="link-style-1">
                        <Link href={`/listing-detail-v1`}>
                          Mazda 6 Sedan 2.0 Executive (A)
                        </Link>
                      </h3>
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car51.webp"
                        src="/assets/images/car-list/car51.webp"
                        alt="image"
                        width={504}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car50.webp"
                        src="/assets/images/car-list/car50.webp"
                        alt="image"
                        width={504}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car53.webp"
                        src="/assets/images/car-list/car53.webp"
                        alt="image"
                        width={507}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car49.webp"
                        src="/assets/images/car-list/car49.webp"
                        alt="image"
                        width={504}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car48.webp"
                        src="/assets/images/car-list/car48.webp"
                        alt="image"
                        width={504}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car52.webp"
                        src="/assets/images/car-list/car52.webp"
                        alt="image"
                        width={504}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car54.webp"
                        src="/assets/images/car-list/car54.webp"
                        alt="image"
                        width={507}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car37.webp"
                        src="/assets/images/car-list/car37.webp"
                        alt="image"
                        width={486}
                        height={336}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car43.webp"
                        src="/assets/images/car-list/car43.webp"
                        alt="image"
                        width={486}
                        height={336}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car55.webp"
                        src="/assets/images/car-list/car55.webp"
                        alt="image"
                        width={507}
                        height={365}
                      />
                ...
                <div className="box-car-list hv-one style-2">
                  <div className="image-group relative">
                    ...
                    <div className="img-style">
                      <Image
                        className="lazyload"
                        data-src="/assets/images/car-list/car42.webp"
                        src="/assets/images/car-list/car42.webp"
                        alt="image"
                        width={486}
                        height={336}
                      />
...
export default ListingGridList;
