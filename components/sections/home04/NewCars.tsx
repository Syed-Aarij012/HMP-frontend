...
import { home04BrandTabs, home04NewCars, getCarDetailHref } from "@/data/cars";
...
function NewCars() {
  ...
  const filteredCars = useMemo(() => {
    return home04NewCars.filter((car) => car.brandType?.includes(activeTab));
  }, [activeTab]);
      ...
      <section className="tf-section3">
        <div className="container">
          <div className="heading-section center mb-30 wow fadeInUp">
            <h2 className="heading-tittle">New car Cars For You</h2>
          </div>
          <div className="flat-tabs themesflat-tabs wow fadeInUp">
            <div className="box-tab center flex-five">
              <ul className="menu-tab tab-title style1 flex magin-auto">
            ...
            <div className="content-tab">
              <div className="content-inner tab-content">
                <div className="list-car-grid-2 gap-48">
                  {filteredCars.map((car) => (
                    <div
                      className="box-car-list hv-one style-2 style-dark"
                      key={car.id}
                    >
