...
import { home04BrandTabs, home04UsedCars, getCarDetailHref } from "@/data/cars";
...
function UsedCars() {
  ...
  const filteredCars = useMemo(() => {
    return home04UsedCars.filter((car) => car.brandType?.includes(activeTab));
  }, [activeTab]);
