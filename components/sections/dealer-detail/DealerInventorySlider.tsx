...
export default function DealerInventorySlider({ cars }: DealerInventorySliderProps) {
  ...
  return (
    <Swiper
      ...
      slidesPerGroup={1}
      navigation={{
        nextEl: ".dealer-inventory-nav-next",
        prevEl: ".dealer-inventory-nav-prev",
      }}
      pagination={{
        el: ".dealer-inventory-pagination",
        clickable: true,
      }}
      breakpoints={{
        575: { slidesPerView: 1, spaceBetween: 12, slidesPerGroup: 1 },
        768: { slidesPerView: 1.5, spaceBetween: 12, slidesPerGroup: 3 },
        1200: { slidesPerView: 2.5, spaceBetween: 30, slidesPerGroup: 1 },
      }}
    >
      {cars.slice(0, 4).map((car) => (
        <SwiperSlide key={car.id}>
          <div className="box-car-list hv-one style-5">
            <div className="image-group relative">
              ...
              <div className="img-style">
                <Image
                  ...
                  src={car.image}
                  alt={car.title}
                  width={car.imageWidth ?? 507}
                  height={car.imageHeight ?? 365}
                />
              </div>
            </div>
              ...
              <div className="icon-box flex flex-wrap">
                <div className="icons flex-three">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d={mileageIconPath} fill="black" />
                  </svg>
      ...
      <span className="d-flex d-xl-none sw-dot-default dealer-inventory-pagination justify-content-center" />
      <div className="nav-next-categories dealer-inventory-nav-next" />
      <div className="nav-prev-categories dealer-inventory-nav-prev" />
    </Swiper>
  );
}
