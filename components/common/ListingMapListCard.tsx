...
type ListingMapListCardProps = {
  listing: ListingMapLocation;
  layout?: "list" | "grid";
};

export default function ListingMapListCard({
  listing,
  layout = "list",
}: ListingMapListCardProps) {
  return (
    <div className="box-car-list hv-one style-1">
      <div className="image-group relative">
        <div className="top">
          <ul className="d-flex gap-8">
            {listing.isNew ? <li className="flag-tag success">New</li> : null}
            {listing.photoCount ? (
      ...
      <div className="content">
        ...
        <div className="days-box flex justify-space align-center">
          <div className="money fs-24 fw-7 lh-30 text-color-2">{listing.price}</div>
