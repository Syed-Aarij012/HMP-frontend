...
import { listingLocationToCar } from "@/lib/listingMapUtils";

type MapListingPopupProps = {
  listing: ListingMapLocation;
  onClose: () => void;
};

export default function MapListingPopup({
  listing,
  onClose,
        ...
        <div className="image-group relative">
          <div className="top flex-two">
            <ul className="d-flex gap-8">
              <li className="flag-tag success">New</li>
          ...
          <ListingCardActions car={listingLocationToCar(listing)} />
        ...
        <div className="content">
          ...
          <div className="days-box flex justify-space align-center">
            <div className="img-author flex-three">
              <Image
                src="/assets/images/author/avt-list10.webp"
                alt="HMP auto"
                width={40}
                height={40}
              />
              <div className="content-infor">
                <span className="fs-14 text-color-2 fw-5">HMP auto</span>
                <p className="fs-12 fw-4">44 minutes ago</p>
              </div>
            </div>
            <Link href={listing.href} className="view-car">
